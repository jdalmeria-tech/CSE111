...
def make_full_name(given_name, family_name):
    ...
    """
    full_name = f"{family_name}; {given_name}" #take note space? I added a space, hope it works - it worked!
    return full_name
...
def extract_given_name(full_name):
    ...
    """
    # Find the index where "; " appears within the full name string.
    semicolon_index = full_name.index("; ") # initially "/" edited to ";" hope it works - it worked!
